...
namespace QUAN__LY_KHACH_HANG {
    ...
    public partial class QLKHDataSet : global::System.Data.DataSet {
        ...
        public partial class khachhangDataTable : global::System.Data.TypedTableBase<khachhangRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public khachhangRow AddkhachhangRow(string makh, string hoten, string sdt, string dchi) {
...
namespace QUAN__LY_KHACH_HANG.QLKHDataSetTableAdapters {
    ...
    public partial class khachhangTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[khachhang] WHERE (([makh] = @Original_makh) AND ((@IsNull_hoten = 1 AND [hoten] IS NULL) OR ([hoten] = @Original_hoten)) AND ((@IsNull_sdt = 1 AND [sdt] IS NULL) OR ([sdt] = @Original_sdt)) AND ((@IsNull_dchi = 1 AND [dchi] IS NULL) OR ([dchi] = @Original_dchi)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[khachhang] ([makh], [hoten], [sdt], [dchi]) VALUES (@makh, @ho" +
                "ten, @sdt, @dchi);\r\nSELECT makh, hoten, sdt, dchi FROM khachhang WHERE (makh = @" +
                "makh)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[khachhang] SET [makh] = @makh, [hoten] = @hoten, [sdt] = @sdt, [dchi] = @dchi WHERE (([makh] = @Original_makh) AND ((@IsNull_hoten = 1 AND [hoten] IS NULL) OR ([hoten] = @Original_hoten)) AND ((@IsNull_sdt = 1 AND [sdt] IS NULL) OR ([sdt] = @Original_sdt)) AND ((@IsNull_dchi = 1 AND [dchi] IS NULL) OR ([dchi] = @Original_dchi)));
SELECT makh, hoten, sdt, dchi FROM khachhang WHERE (makh = @makh)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QUAN__LY_KHACH_HANG.Properties.Settings.Default.QLKHConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT makh, hoten, sdt, dchi FROM dbo.khachhang";
        ...
        public virtual int Delete(string Original_makh, string Original_hoten, string Original_sdt, string Original_dchi) {
        ...
        public virtual int Insert(string makh, string hoten, string sdt, string dchi) {
            if ((makh == null)) {
        ...
        public virtual int Update(string makh, string hoten, string sdt, string dchi, string Original_makh, string Original_hoten, string Original_sdt, string Original_dchi) {
            if ((makh == null)) {
                throw new global::System.ArgumentNullException("makh");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string hoten, string sdt, string dchi, string Original_makh, string Original_hoten, string Original_sdt, string Original_dchi) {
            return this.Update(Original_makh, hoten, sdt, dchi, Original_makh, Original_hoten, Original_sdt, Original_dchi);
        }
    }
